        ...
        public static void writeFile()
        {
            try
            {
                ...
                foreach (ConnectionObject dataObject in SettingsObject.ListConnections)
                {
                    ...
                    connect.SetAttribute("pop3host", dataObject.Pop3ID.ToString());
                    connect.SetAttribute("smtphost", dataObject.SmtpID.ToString());
                    connect.SetAttribute("email", dataObject.AddressID.ToString());
            ...
            try
            {
                ...
                if (connections != null)
                {
                    ...
                    foreach (XmlNode connect in dataNodes)
                    {
                        ...
                        item.AddressID = Convert.ToInt32(getValue(connect, "addressid"));
