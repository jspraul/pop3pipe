...
namespace POP3Pipe
{
    class ManagerSMTP
    {
        ...
        {
            MailMessage message = new MailMessage("Da_Groovy@gmx.de", "familielau@alice-dsl.de", "Test Subject", "Test Body");
            ...
            try
            {
                Console.WriteLine("Trying port 465 (SSL)");
                smtpClient.Host = "mail.gmx.net";
                smtpClient.Port = 465;
                smtpClient.EnableSsl = true;
                NetworkCredential credentials = new NetworkCredential("Da_Groovy@gmx.de", "h8tt0r1Hanz0");
            ...
            try
            {
                Console.WriteLine("Trying port 587");
                smtpClient.Port = 587;
            ...
            try
            {
                Console.WriteLine("Trying port 25");
                smtpClient.Port = 25;
                smtpClient.Send(message);
            }
            catch (Exception ex)
        ...
        private MailMessage mapper(Message msg, AddressObject addObj, HostConfigObject smtpObj)
        {
            Console.WriteLine("-------------------------");
        ...
        public void Send(Message[] messages, HostConfigObject smtpObj, AddressObject addObj)
        {
